...
const Container = styled("div")<StyleVariables>`
  ...
  --primary-color-text-shade-rgb: ${({ $calendarColoredTextRGB }) =>
    $calendarColoredTextRGB};
  --background-color-rgb: ${({ $backgroundColorRGB }) => $backgroundColorRGB};
  --background-color-contrast-rgb: ${({ $backgroundColorContrastRGB }) =>
    $backgroundColorContrastRGB};
  --primary-color-rgb: ${({ $primaryColorRGB }) => $primaryColorRGB};
  --primary-color-contrast-rgb: ${({ $primaryColorContrastRGB }) =>
    $primaryColorContrastRGB};
...
export const ScheduleMeeting: React.FC<Props> = ({
  ...
  const textColorRGB =
    textColor || (isBackgroundColorDark ? "255, 255, 255" : "34, 34, 34");
  const primaryColorContrastRGB = Color(primaryColor).isDark()
    ? "255, 255, 255"
    : "34, 34, 34";
  const backgroundColorContrastRGB = isBackgroundColorDark
    ? "255, 255, 255"
    : "34, 34, 34";
